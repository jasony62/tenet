...
public class OffsetStorageReaderImpl implements CloseableOffsetStorageReader {
    ...
    private final io.ctsi.tenet.kafka.connect.storage.OffsetBackingStore backingStore;
    ...
    public OffsetStorageReaderImpl(io.ctsi.tenet.kafka.connect.storage.OffsetBackingStore backingStore, String namespace,
    ...
    public <T> Map<Map<String, T>, Map<String, Object>> offsets(Collection<Map<String, T>> partitions) {
        ...
        for (Map<String, T> key : partitions) {
            try {
                ...
                io.ctsi.tenet.kafka.connect.storage.OffsetUtils.validateFormat(key);
        ...
        for (Map.Entry<ByteBuffer, ByteBuffer> rawEntry : raw.entrySet()) {
            try {
                ...
                io.ctsi.tenet.kafka.connect.storage.OffsetUtils.validateFormat(deserializedValue);
