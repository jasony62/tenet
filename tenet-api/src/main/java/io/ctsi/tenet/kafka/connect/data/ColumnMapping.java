...
import io.ctsi.tenet.kafka.connect.util.ColumnDefinition;
...
public class ColumnMapping {
   ...
   * @param field        the corresponding {@link Field} within the {@link io.ctsi.tenet.kafka.connect.data.Schema}; may not be null
   */
