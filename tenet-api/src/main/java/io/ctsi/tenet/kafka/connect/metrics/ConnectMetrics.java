...
public class ConnectMetrics {
    ...
    public static final String JMX_PREFIX = "tenet.connect";
    ...
    private  static final String Reporter = "org.apache.kafka.common.metrics.JmxReporter";
     ...
     */
    public ConnectMetrics(String workerId, Map<String,Object> config,Time time) {
        this(workerId,
                time,
                1,
                30000,
              "INFO",
               Arrays.asList(Reporter.split(","))
        );
    }
    ...
    public ConnectMetrics(String workerId, Time time, int numSamples, long sampleWindowMs, String metricsRecordingLevel,
        ...
        List<MetricsReporter> reporters = getConfiguredInstances(reporter, MetricsReporter.class, Collections.emptyMap());
