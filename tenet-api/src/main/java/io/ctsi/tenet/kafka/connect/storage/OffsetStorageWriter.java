...
public class OffsetStorageWriter {
    ...
    public OffsetStorageWriter(io.ctsi.tenet.kafka.connect.storage.OffsetBackingStore backingStore,
        ...
        synchronized (this) {
            ...
            try {
                ...
                for (Map.Entry<Map<String, Object>, Map<String, Object>> entry : toFlush.entrySet()) {
                    ...
                    io.ctsi.tenet.kafka.connect.storage.OffsetUtils.validateFormat(entry.getKey());
                    io.ctsi.tenet.kafka.connect.storage.OffsetUtils.validateFormat(entry.getValue());
