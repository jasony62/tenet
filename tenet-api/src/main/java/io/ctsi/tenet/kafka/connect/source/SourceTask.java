...
public abstract class SourceTask {
    ...
    protected io.ctsi.tenet.kafka.connect.source.SourceTaskContext context;

    /**
     * Initialize this SourceTask with the specified context object.
     */
    public void initialize(io.ctsi.tenet.kafka.connect.source.SourceTaskContext context) {
