...
import io.ctsi.tenet.kafka.connect.transforms.util.NonEmptyListValidator;
import io.ctsi.tenet.kafka.connect.transforms.util.SimpleConfig;
import io.ctsi.tenet.kafka.connect.data.Field;
import io.ctsi.tenet.kafka.connect.data.Schema;
import io.ctsi.tenet.kafka.connect.data.SchemaBuilder;
...
import static io.ctsi.tenet.kafka.connect.transforms.util.Requirements.requireStruct;
