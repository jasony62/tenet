...
import io.ctsi.tenet.kafka.mongodb.sink.cdc.CdcHandler;
import io.ctsi.tenet.kafka.mongodb.sink.processor.PostProcessors;
import io.ctsi.tenet.kafka.mongodb.sink.processor.id.strategy.FullKeyStrategy;
...
import io.ctsi.tenet.kafka.mongodb.sink.processor.id.strategy.ProvidedInKeyStrategy;
import io.ctsi.tenet.kafka.mongodb.sink.writemodel.strategy.DeleteOneDefaultStrategy;
import io.ctsi.tenet.kafka.mongodb.sink.writemodel.strategy.WriteModelStrategy;
...
import io.ctsi.tenet.kafka.mongodb.util.Validators;
...
import static io.ctsi.tenet.kafka.mongodb.sink.MongoSinkConfig.CONNECTION_URI_CONFIG;
import static io.ctsi.tenet.kafka.mongodb.sink.MongoSinkConfig.TOPICS_CONFIG;
...
public class MongoSinkTopicConfig extends AbstractConfig {
    ...
    public static final String MAX_NUM_RETRIES_CONFIG = "max.retries";
...
//  public static final String RETRIES_DEFER_TIMEOUT_CONFIG = "retries.defer.timeout";
    public static final String RETRIES_DEFER_TIMEOUT_CONFIG = "retry.backoff.ms";
    ...
    private static final String POST_PROCESSOR_CHAIN_DEFAULT =
            "io.ctsi.tenet.kafka.mongodb.sink.processor.DocumentIdAdder";
    ...
    private static final String WRITEMODEL_STRATEGY_DEFAULT =
            "io.ctsi.tenet.kafka.mongodb.sink.writemodel.strategy.ReplaceOneDefaultStrategy";

//  public static final String MAX_BATCH_SIZE_CONFIG = "max.batch.size";
    public static final String MAX_BATCH_SIZE_CONFIG = "batch.size";
    ...
    private static ConfigDef createConfigDef() {
        ...
        configDef.define(
                ...
                Validators.errorCheckingValueValidator("A valid JSON array", ConfigHelper::jsonArrayFromString),
                ConfigDef.Importance.LOW,
