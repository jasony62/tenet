...
public class ReplaceOneDefaultStrategy implements io.ctsi.tenet.kafka.mongodb.sink.writemodel.strategy.WriteModelStrategy {
  ...
  public WriteModel<BsonDocument> createWriteModel(final SinkDocument document) {
    ...
    return new ReplaceOneModel<>(new BsonDocument(MongoSinkTopicConfig.ID_FIELD, vd.get(MongoSinkTopicConfig.ID_FIELD)), vd, REPLACE_OPTIONS);
  }
}
